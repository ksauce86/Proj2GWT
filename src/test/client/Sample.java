...
public class Sample implements EntryPoint, ClickHandler
{
   ...
   Button destroyButton = new Button("Delete worker");
   ...
   public void onModuleLoad()
   {
      ...
      destroyButton.addClickHandler(this);
   ...
   public void onClick(ClickEvent e) {
      ...
      if (source == addButton) {
         ...
         String encData = URL.encode("name") + "=" +
               ...
               URL.encode("department") + "=" +
               URL.encode(deptBox.getText());
            String url = "http://localhost:3000/workers/edit";
            postRequest(url,encData);
      }
         ...
         loginForm(selectedWorker.username,
            "");
      }
   }
   ...
   private void loginForm (String userStr, 
         String passStr) 
      {
         VerticalPanel editPanel = new VerticalPanel();
         HorizontalPanel row1 = new HorizontalPanel();
